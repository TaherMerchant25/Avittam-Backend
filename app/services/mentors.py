...
async def create_mentor_request(
    ...
    request_data = {
        ...
        "selected_program_id": input_data.selected_program_id,
        "selected_program_name": input_data.selected_program_name,
        "selected_program_term": input_data.selected_program_term,
        "selected_program_price_coins": input_data.selected_program_price_coins,
